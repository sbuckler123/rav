...
export default function Dashboard() {
  ...
  return (
    <section className="container mx-auto px-4 md:px-6 lg:px-8 max-w-7xl 2xl:max-w-screen-2xl mt-6 lg:-mt-8 relative z-20">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 2xl:grid-cols-4 gap-4 sm:gap-6 items-stretch">
