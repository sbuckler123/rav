...
export default function Footer() {
  ...
  <div className="flex flex-col">
    ...
    <span>בנין הרבנות הראשית לישראל</span>
          ...
          {/* עמודה רביעית - מידע משפטי */}
          <div>
            <h4 className="font-bold mb-4">מידע משפטי</h4>
            <ul className="space-y-2 text-sm">
              <li><Link to="/terms" className="hover:text-secondary transition-colors">תנאי שימוש</Link></li>
              <li><Link to="/privacy" className="hover:text-secondary transition-colors">מדיניות פרטיות</Link></li>
              <li><Link to="/cookies" className="hover:text-secondary transition-colors">מדיניות עוגיות</Link></li>
              <li><Link to="/accessibility" className="hover:text-secondary transition-colors">הצהרת נגישות</Link></li>
            </ul>
          </div>
        </div>
