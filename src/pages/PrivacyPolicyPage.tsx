...
export default function PrivacyPolicyPage() {
  return (
    <div className="min-h-screen bg-background">
      <SEO title="מדיניות פרטיות" description="מדיניות הפרטיות של אתר הרב קלמן מאיר בר." noindex />
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-3xl py-8 sm:py-12">
        <article className="space-y-8 sm:space-y-10" lang="he" dir="rtl">
          ...
          <Section title="9. זכויות המשתמש">
            ...
            <p className="mt-3 text-sm text-muted-foreground">
              למימוש זכויות אלו, פנו אלינו בכתובת המפורטת בסעיף 12. נטפל בבקשתכם
              תוך 30 יום.
            </p>
          </Section>
          ...
          {/* ── 10. תקופת שמירת מידע ── */}
          <Section title="10. תקופת שמירת מידע">
            <p className="mb-3">
              אנו שומרים את פרטיכם רק לפרק הזמן הדרוש למטרות שלשמן נאספו, בהתאם
              לעקרון מזעור המידע. ביחס לשאלות שנשלחו דרך הטופס:
            </p>
            <BulletList items={[
              'שם, דוא"ל ותוכן השאלה — נשמרים עד 24 חודשים מתום הטיפול בפנייה',
              'שאלות שלא ניתנה הסכמה לפרסומן — נמחקות לחלוטין בתום התקופה',
              'שאלות שהסכמתם לפרסומן באנונימיות — שמכם וכתובת הדוא"ל יוסרו לאחר 24 חודשים, אך תוכן השאלה והתשובה עשויים להישמר באתר באופן אנונימי לתועלת הציבור',
              'מנויי ניוזלטר — נשמרים כל עוד ההרשמה פעילה. עם ההסרה, המידע יימחק ללא דיחוי',
            ]} />
            <p className="mt-3 text-sm text-muted-foreground">
              ניתן לבקש מחיקה מוקדמת של המידע שלכם בכל עת, בפנייה אלינו לפרטים
              שבסעיף 12.
            </p>
          </Section>
